...
String ssid = "TECNO SPARK 5 Air"; // Place your home wifi ssid
String password = "1234567890#";   //// Place your home wifi password
...
void setup()
{
  ...
  Serial.begin(9600);
  // getsub();
  double temp = module.readCelsius();
  Serial.print(temp);
...
void loop()
{
  ...
  if (millis() - currentread > 1000)
  {
    ...
    currentValue = module.readCelsius() + double(temp_offset);
